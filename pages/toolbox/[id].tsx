    ...
    return (
      <div style={{ width: "100%", minHeight: "100vh", padding: "2rem" }}>
        <Paper p="xl" withBorder radius="lg" style={{ textAlign: "center" }}>
          <Title order={2} mb="md" style={{ color: "#1e3a8a" }}>
            Tool nicht gefunden
          </Title>
          <Text c="dimmed" mb="lg">
      ...
      <Stack gap="xl">
        ...
        >
          <Stack gap="md">
            ...
            <Title order={1} size="3rem" style={{ color: "white" }}>
              {tool.title}
            </Title>
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Stack gap="xl">
              ...
              <Paper p="xl" withBorder radius="lg" shadow="sm">
                <Title order={2} size="h3" mb="md" style={{ color: "#1e3a8a" }}>
                  Beschreibung
                </Title>
          ...
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Stack gap="md">
              <Paper p="xl" withBorder radius="lg" shadow="sm">
                <Stack gap="md">
                  <Title order={3} size="h4" style={{ color: "#1e3a8a" }}>
                    Informationen
                  </Title>
                  <Divider />
                  <div>
